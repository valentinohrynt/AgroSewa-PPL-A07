...
@section('content-box-info')
    <div class="box-info">
        <li style="display: flex; flex-direction: column; align-items: start;">
            <i style="width: 10rem; height: 10rem; font-size: 6rem; position:relative; left: 50%; transform: translateX(-50%);"
                class="fas fa-person"></i>
            <span class="text-profil">
                ...
                <div class="profil">
                    <h4>Alamat</h4>
                    <input type="text"
                        value="{{ $government->street }}, {{ $government->village->name }}, {{ $government->village->district->name }}"
                        disabled>
                </div>
            </span>
        </li>
        <li style="display: flex; flex-direction: column; align-items: start;">
            <i style="width: 10rem; height: 10rem; font-size: 6rem; position:relative; left: 50%; transform: translateX(-50%);"
                class="fas fa-right-to-bracket"></i>
...
@section('edit-button')
    <a href="{{ route('EditProfilPemerintah()') }}" class="btn btn-info">Edit Data Akun <i
