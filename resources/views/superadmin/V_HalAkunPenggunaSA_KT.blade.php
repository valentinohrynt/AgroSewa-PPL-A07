...
<div class="left">
    ...
    <ul class="breadcrumb">
        ...
        <i class="fas fa-chevron-right"></i>
        <li>
            <a href="#" class="active">Daftar Akun Kelompok Tani</a>
        </li>
    </ul>
</div>
@endsection
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr onclick="submitForm('{{ $item->id }}')" style="cursor: pointer;">
                ...
                <form id="form_{{ $item->id }}" action="{{route('HalDataAkunPenggunaSA_KT()',['lender_id' => $encryptedLenderId])}}">
                    @csrf
